...
Individual assignment 5 for DSCI 310 in UBC, create a toy package with a
simple function in R.

## Installation

You can install the development version of dsci310.ia5 from
[GitHub](https://github.com/) with:

``` r
# install.packages("devtools")
devtools::install_github("jossiej00/dsci310.ia5")
```
...
That’s exactly what `dsci310.ia5::str_split_one()` does.
